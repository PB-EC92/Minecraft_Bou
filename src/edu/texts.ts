 ...
 *
 * Ton gentil et encourageant, jamais de reproche. Tournures neutres en genre
 * (« Appuie sans lâcher » plutôt que « Reste appuyé(e) ») : le jeu ne sait pas
 * encore qui joue (profils au J4).
 *
...
export const HOLD_TO_BREAK: ChildText = {
  debutant: `Appuie sans lâcher${NBSP}!`,
  autonome: "Appuie sans lâcher sur un bloc pour le casser.",
};
...
export const FULL_BAG: ChildText = {
  ...
  autonome: `Ton sac est plein${NBSP}: vide une case en posant ses blocs.`,
};

/** Fleur posée sans bloc plein dessous. */
...
export const WELCOME: ChildText = {
  ...
  autonome: "Appuie sans lâcher sur un bloc pour le casser et le ramasser.",
};
